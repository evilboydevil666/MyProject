...
// Import data from separate modules if they exist, otherwise use embedded data
let races, classes, feats, equipment;

try {
  // Try to import if modules exist
  races = require('./pathfinderRaces.js').pathfinderRaces;
  classes = require('./pathfinderClasses.js').pathfinderClasses;
  feats = require('./pathfinderFeats.js').pathfinderFeats;
} catch (error) {
  // Use embedded data if imports fail
  races = {
    core: [
      {
        id: 'human',
